...
<div align="center">
  ...
  <p><i>Figure 1: 50 FashionMNIST samples generated using the trained diffusion model.</i></p>
</div>
...
**Objective:** Teach a pre-trained text-to-image model (Stable Diffusion v1.5) to generate images of a specific custom subject (a car) in novel environments.
...
<div align="center">
  ...
  <p><i>Figure 2: The custom &lt;sks&gt; car generated in a novel environment ("a photo of a &lt;sks&gt; car in a green field").</i></p>
</div>
